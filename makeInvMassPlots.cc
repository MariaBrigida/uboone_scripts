...
void makeInvMassPlots(const char* inputFilesList, const char* channel, const int implDir) {
    ...
    for (Long64_t entry = 0; entry < nEntries; ++entry) {
        ...
        if (trueInteractionType == 1006 || trueInteractionType == 1008 || trueInteractionType == 1013 || trueInteractionType == 1015)
        {
            // Only fill for interactions with a true pi0 in the final state
        ...
        if (trueProtonE > 0 && (trueInteractionType == 1006 || trueInteractionType == 1009 || trueInteractionType == 1013 || trueInteractionType == 1016))
        {
